...
export class TopObject extends DrawnObjectBase {
    ...
    damageArea(xv, yv, wv, hv) {
        ...
        this._damageRectW = Math.max(this._damageRectW, xv + wv - this._damageRectX);
        this._damageRectH = Math.max(this._damageRectH, yv + hv - this._damageRectY);
        */
        // Update the damage rectangle to include the new damaged area
